...
class StringMatcher:
    ...
    def preciseBatchMatch(self, path, min_similarity, max_similarity=1.0):
        ...
        gold_mapping_path = 'C:/Users/D072202/RData2Graph/rdata2graph/data/sap_hilti_data/final_testset.csv'
        gold_mapping = pd.read_csv(gold_mapping_path, sep='\t', header=None, names=['src_id', 'tgt_id', 'label'])
        f = open('C:/Users/D072202/RData2Graph/rdata2graph/data/sap_hilti_data/possible_matches.csv','w+')
        ...
        lines = dict()
        with open("C:/Users/D072202/RData2Graph/rdata2graph/data/sap_hilti_data/possible_matches.csv",mode="r") as f:
                for line in f:
                    line = line.split("\t")
                    ...
                    if not line[0] + "\t" + line[1] in lines.keys():
                        ...
                        lines[line[0] + "\t" + line[1]] = float(line[2])
        with open("C:/Users/D072202/RData2Graph/rdata2graph/data/sap_hilti_data/possible_matches.csv",mode="w+") as f2:
...
if __name__ == '__main__':
    try:
        os.remove("C:/Users/D072202/RData2Graph/rdata2graph/data/sap_hilti_data/possible_matches.csv")
    except FileNotFoundError:
        pass

    # match products
    index_properties = ["<http://rdata2graph.sap.com/hilti_erp/property/mara_fert.maktx>","<http://rdata2graph.sap.com/hilti_web/property/products.name>"]
    ...
    stringmatcher.preciseBatchMatch("", 0.0)
